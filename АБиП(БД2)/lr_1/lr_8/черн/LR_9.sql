...
grant unlimited tablespace to C##KASCORE --есть неограниченная квота на любое табличное пространство в бд
commit;
...
---------13---------
--Найдите созданные таблицы и кластер в представлениях словаря Oracle
...
---------14---------
--Создайте частный синоним для таблицы С.
...
---------15---------
--Создайте публичный синоним для таблицы B.
