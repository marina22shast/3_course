...
namespace lab4
{
    class EnigmaMachine
    {
        ...
        private const string rotorL = "FKQHTLXOCBJSPDZRAMEWNIUYGV"; 
        private const string rotorM = "AJDKSIRUXBLHWTMCQGZNPYFVOE";
        private const string rotorR = "ESOVPZJAYQUIRHXLNFTGKDCMWB";

        //private const string reflectorCDuhnconf = "RDOBJNTKVEHMLFCWZAXGYIPSUQ";


        private const string re = "YRUHQSLDPXNGOKMIEBFZCWVJAT";
        private const int rightPosition = 0;
        private const int centerPosition = 2;
        ...
        public EnigmaMachine()
        {
            ...
            Rotor rL = new Rotor(rotorL, 'I', "II");
            Rotor rM = new Rotor(rotorM, 'E', "B");
            Rotor rR = new Rotor(rotorR, 'Q', "VIII");


            rotors = new Rotor[] { rL, rM, rR }; // Default ordering of rotors
            reflector = new Rotor(re, ' ', "");
        }
