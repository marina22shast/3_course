...
namespace lab10
{
    public class ElGamal
    {
        ...
        public static string Encrypt(string value, string pathToFile)
        {
            string result = "";
            List<BigInteger> cipherASCIIElGamal = EncryptMethod(Encoding.Unicode.GetBytes(value));

            File.WriteAllText(pathToFile, Convert.ToString(x));
        ...
        public static string Decrypt(string value, string pathToFile)
        {
